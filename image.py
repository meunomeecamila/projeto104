...
cv2.putText(img,"Terra",(300,270),cv2.FONT_HERSHEY_COMPLEX,0.5,(0,0,255))
cv2.putText(img,"Marte",(400,270),cv2.FONT_HERSHEY_COMPLEX,0.5,(255,0,0))
cv2.putText(img,"Jupiter",(500,90),cv2.FONT_HERSHEY_COMPLEX,0.5,(255,255,255))
cv2.putText(img,"Saturno",(720,110),cv2.FONT_HERSHEY_COMPLEX,0.5,(255,0,0))
cv2.putText(img,"Urano",(950,130),cv2.FONT_HERSHEY_COMPLEX,0.5,(0,0,255))
